    ...
    DR002: [
      {
        id: "m1",
        sender: "DR002",
        text: "Have you seen the latest MRI results for patient Thomas Hughes?",
        time: "Yesterday",
      },
      {
        id: "m2",
        sender: "USR001",
        text: "Not yet. Are they in the system already?",
        time: "Yesterday",
      },
      {
        id: "m3",
        sender: "DR002",
        text: "Yes, they just came in. The MRI results are in. We need to discuss them.",
        time: "Yesterday",
      },
    ],
    DR003: [
      {
        id: "m1",
        sender: "USR001",
        text: "Dr. Davis, we have a 7-year-old with high fever in room 205.",
        time: "Yesterday",
      },
      {
        id: "m2",
        sender: "DR003",
        text: "I'm on my way. Did you administer any medication yet?",
        time: "Yesterday",
      },
      {
        id: "m3",
        sender: "USR001",
        text: "Yes, gave them children's Tylenol as per protocol. Temp was 102.3°F.",
        time: "Yesterday",
      },
      {
        id: "m4",
        sender: "DR003",
        text: "Good. I'll be there in 5 minutes. Can you prepare room 302 for the next patient?",
        time: "Yesterday",
      },
    ],
    NR001: [
      {
        id: "m1",
        sender: "NR001",
        text: "Hey Amanda, can you cover my shift tomorrow morning? Family emergency.",
        time: "2 days ago",
      },
      {
        id: "m2",
        sender: "USR001",
        text: "Sure, I can do that. Everything okay?",
        time: "2 days ago",
      },
      {
        id: "m3",
        sender: "NR001",
        text: "Emergency case coming in. Need assistance.",
        time: "2 days ago",
      },
    ],
  };
